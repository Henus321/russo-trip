  ...
  return (
    <div className="safety">
      <div className="safety__column">
        ...
        <p className="sefety__paragraph">
          Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quasi, vero?
          Distinctio, suscipit cum repellendus nam, reprehenderit quisquam
          libero alias ratione dolore cupiditate blanditiis.
        </p>
      </div>
      ...
      <div className="safety__column">
        ...
        <p className="sefety__paragraph">
          Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quasi, vero?
          Distinctio, suscipit cum repellendus nam, reprehenderit quisquam
          libero alias ratione dolore cupiditate blanditiis ullam, recusandae
          delectus maxime voluptatum eaque provident. Lorem ipsum dolor sit amet
          consectetur adipisicing elit. Quisquam, saepe dolorum.
        </p>
      </div>
      ...
      <div className="safety__column">
        ...
        <p className="sefety__paragraph">
          Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quasi, vero?
          Distinctio, suscipit cum <strong>repellendus nam</strong>,
